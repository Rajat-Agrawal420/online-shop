...
<body>
    ...
    <section class="dashboard-area dashboard_purchase">
        ...
        if (isset($_SESSION['user_id'])) {
            $sql = "SELECT od.* FROM orders o INNER JOIN order_detail od ON o.id=od.order_id WHERE o.user_id='" . $_SESSION['user_id'] . "' AND (o.payment_status='PAID' OR payment_mode='COD') ORDER BY o.order_date DESC";
        } else {
            $sql = "SELECT * FROM order_detail WHERE 0";
        }
            ...
            <div class="container">
                <div class="shortcode_modules">
                    <div class="modules__title ">
                        ...
                        <h3 class="text-center scolor">My Orders</h3>

                    </div>

                    <h6 class="text-center pcolor" style="padding:2rem;"></h6>
                ...
                <div class="product_archive">
                    ...
                    <div class="row mt-2">
                        ...
                        <?php
                            ...
                            echo '<h6 style="margin:auto; margin-top:20px;">No Orders Yet.</h6>';
                        } ?>
                        <div class="col-md-12">
